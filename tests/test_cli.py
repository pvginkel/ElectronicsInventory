...
class TestHandleLoadTestData:
    ...
    def test_reports_target_database(self, monkeypatch: pytest.MonkeyPatch, capsys: pytest.CaptureFixture[str]) -> None:
    ...
    def test_hook_failure_exits_with_code_1(self, monkeypatch: pytest.MonkeyPatch, capsys: pytest.CaptureFixture[str]) -> None:
...
class TestHandleUpgradeDb:
    ...
    def test_calls_post_migration_hook_unconditionally(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_calls_post_migration_hook_after_migrations(self, monkeypatch: pytest.MonkeyPatch) -> None:
