...
class TestCheckAuthorization:
    ...
    EI uses authenticated-only default: any valid token passes unless
    ...
    def test_authenticated_user_passes_without_allow_roles(self):
        ...
        # Should not raise - authenticated-only default
    ...
    def test_authenticated_user_with_any_role_passes(self):
        ...
        # Should not raise - no @allow_roles means any authenticated user passes
        check_authorization(auth_context, view_func=regular_endpoint)

    def test_empty_roles_passes_without_allow_roles(self):
        """Test that a user with no roles still passes the default check (authenticated-only)."""
        auth_context = AuthContext(
        ...
        # Should not raise - EI default is authenticated-only (no role check)
        check_authorization(auth_context, view_func=None)
    ...
    def test_allowed_role_grants_access(self):
        ...
        # Should not raise - editor role is allowed
    ...
    def test_one_of_multiple_allowed_roles_grants_access(self):
        ...
        # Should not raise - viewer is one of the allowed roles
